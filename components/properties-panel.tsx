...
export default function PropertiesPanel({
  ...
  const handleRemoveFallbackChannel = (index: number) => {
    if (nodeData?.commandControlData) {
      const newChannels = nodeData.commandControlData.fallbackChannels.filter(
        (_, i) => i !== index,
      );
      handleCommandControlChange('fallbackChannels', newChannels);
    }
  ...
  const handleRemovePersistenceMethod = (index: number) => {
    if (nodeData?.commandControlData) {
      const newMethods = nodeData.commandControlData.persistenceMethods.filter(
        (_, i) => i !== index,
      );
      handleCommandControlChange('persistenceMethods', newMethods);
    }
    ...
    return (
      <aside className="ip-panel w-80 flex-shrink-0 border-l p-4">
        <h2 className="mb-4 text-lg font-semibold">
          {totalSelected > 1 ? 'Selection' : 'Properties'}
        </h2>
        {totalSelected > 1 ? (
          <div className="space-y-2">
            <p className="text-sm text-gray-300">
              {selectedNodeCount} node{selectedNodeCount === 1 ? '' : 's'} and {selectedEdgeCount}{' '}
              edge{selectedEdgeCount === 1 ? '' : 's'} selected.
            </p>
          ...
          <p className="text-sm text-gray-400">
            Select a node or edge to view/edit its properties.
          </p>
        )}
      </aside>
    );
              ...
              <div>
                <div className="mb-2 flex justify-between">
                  ...
                  <span className="text-xs text-gray-400">
                    {Math.round((nodeData.transparency || 0.2) * 100)}%
                  </span>
                </div>
                <Slider
          ...
          {nodeData.type !== 'group' && nodeData.type !== 'attacker' && (
            <div className="border-t border-gray-700 pt-4">
              ...
              <Select
                ...
                onValueChange={(value: InvestigationStatus) =>
                  handleNodeChange('investigationStatus', value)
                }
              >
          ...
          {nodeData.type === 'identity' && nodeData.identityData && (
            <>
              ...
              <div>
                ...
                >
                  <SelectTrigger className="mt-1 w-full border-gray-700 bg-gray-800 text-white">
              ...
              <div>
                ...
                <Button
                  ...
                  className="mt-2 w-full border-gray-700 bg-transparent text-white hover:bg-gray-700"
                >
            ...
            <>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleExfiltrationChange('volumeGB', Number.parseFloat(e.target.value) || 0)
                  }
                  className="mt-1 border-gray-700 bg-gray-800 text-white"
                  placeholder="0"
                />
            ...
            <>
              <div>
                ...
                <Input
                  ...
                  className="mt-1 border-gray-700 bg-gray-800 font-mono text-white"
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCloudTenantChange('resourceCount', Number.parseInt(e.target.value) || 0)
                  }
                  className="mt-1 border-gray-700 bg-gray-800 text-white"
            ...
            <>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleCommandControlChange('jitter', Number.parseInt(e.target.value) || 0)
                  }
                  className="mt-1 border-gray-700 bg-gray-800 text-white"
                  placeholder="0-100"
                />
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleCommandControlChange('killSwitchEnabled', checked)
                    }
                  />
            ...
            <div>
              ...
              {(nodeData.actions || []).map((action, index) => {
                ...
                return (
                  <div
                    key={action.id}
                    className="mt-2 space-y-2 rounded-md border border-gray-700 p-3"
                  >
                      ...
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        >
                          <SelectTrigger
                            ...
                            className="flex-1 border-gray-700 bg-gray-800 text-xs text-white"
                          >
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className="mt-1 border-gray-700 bg-gray-800 text-xs text-white"
              ...
              <div className="mt-2 space-y-2">
                    ...
                    <>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleDisplaySettingChange('showHostname', checked)
                          }
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleDisplaySettingChange('showIpAddress', checked)
                          }
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleDisplaySettingChange('showOs', checked)
                          }
                        />
                      </div>
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            handleDisplaySettingChange('showServices', checked)
                          }
                        />
                      </div>
                    </>
                  ...
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showUsername', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showDomain', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showAccountType', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showAccountSource', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showAccountStatus', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showMfaStatus', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showRiskLevel', checked)
                        }
                      />
                    </div>
                  </>
                  ...
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showMethod', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showDestination', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showStatus', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showVolume', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showDataTypes', checked)
                        }
                      />
                    </div>
                  </>
                  ...
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showC2Type', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showC2Server', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showBeaconInterval', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showImplantType', checked)
                        }
                      />
                    </div>
                  </>
                  ...
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showTenantId', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showTenantName', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showCloudProvider', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showTenantType', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showRegion', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showEnvironment', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showResourceCount', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showSecurityScore', checked)
                        }
                      />
                    </div>
                  </>
                  ...
                  <>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showTargetIndustries', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showAttackVectors', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showInfrastructureAge', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showLastSeen', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showFirstSeen', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showInfrastructureStatus', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showThreatActor', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showLocation', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showHostingProvider', checked)
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleDisplaySettingChange('showInfrastructureType', checked)
                        }
                      />
                    </div>
                  </>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleDisplaySettingChange('showCriticality', checked)
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleDisplaySettingChange('showActions', checked)
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleDisplaySettingChange('showDescription', checked)
                    }
                  />
                </div>
              </div>
            ...
            <div className="mt-2 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleEdgeDisplaySettingChange('showLabel', checked)
                  }
                />
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleEdgeDisplaySettingChange('showTimestamp', checked)
                  }
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleEdgeDisplaySettingChange('showMitreId', checked)
                  }
                />
              </div>
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    handleEdgeDisplaySettingChange('showDescription', checked)
                  }
                />
              </div>
              {edgeData.actionType === 'Command & Control' && (
                <>
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleEdgeDisplaySettingChange('showC2Channel', checked)
                      }
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleEdgeDisplaySettingChange('showC2Framework', checked)
                      }
                    />
                  </div>
                </>
